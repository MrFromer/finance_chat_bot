...
```
cd existing_repo
git remote add origin https://codelab.tpu.ru/nvs72/financial-analysys.git
...
- [ ] [Set up project integrations](https://codelab.tpu.ru/nvs72/financial-analysys/-/settings/integrations)
